...
./makeElement.sh Interview_Interview_Button_Attached_Audio "Attach Audio" button 1 false false false false false .
./makeElement.sh Interview_Interview_Attached_Video "Attached Video" file 1 false false true false false .
./makeElement.sh Interview_Interview_Button_Attached_Video "Attach Video" button 1 false false false false false .
...
./makeElement.sh Agent_Role_Agent_Role_Role "Role" dropdown 1 false false true false false .
